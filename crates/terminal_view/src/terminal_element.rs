        ...
        self.interactivity.prepaint(
            ...
            |_, _, hitbox, window, cx| {
                ...
                let (hover_tooltip, hover_match) = self.terminal.update(cx, |terminal, cx| {
                    ...
                    {
                        // Identity, not equality: the terminal shifts a carried
                        // match's lines as output scrolls, and comparing whole
                        // words made the link blink out for the frames in which
                        // the two disagreed about where it was.
