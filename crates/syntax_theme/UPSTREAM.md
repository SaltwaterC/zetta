# Zetta syntax_theme fork

This crate is synchronized with `zed/crates/syntax_theme` at Zed revision
...
- `publish` is `false`.
- the `include_str!` for the bundled One theme points at
  `../../../zed/assets/themes/one/one.json`.
