...
_zmux_mosh_candidates() {
    ...
    for option in --client --server --predict -a -n -o --predict-overwrite --no-predict-overwrite -k --keep-alive --scrollback --no-scrollback -4 -6 --family -p --port --bind-server --ssh --ssh-pty --no-ssh-pty --init --no-init --local --experimental-remote-ip -h --help -V --version --; do
        ...
        case $words[CURRENT-1] in
            ...
            *)
                if (( delimiter )); then
                    ...
                    _zetta_options --client --server --predict -a -n -o --predict-overwrite --no-predict-overwrite -k --keep-alive --scrollback --no-scrollback -4 -6 --family -p --port --bind-server --ssh --ssh-pty --no-ssh-pty --init --no-init --local --experimental-remote-ip -h --help -V --version --
                else
                    _zmux_mosh_candidates
                fi
                ;;
