...
fn open_launch_window(launch: ApplicationLaunch, cx: &mut App) {
    ...
    let opened = if launch.fresh_window {
        ...
        open_zetta_window(
            ...
            ZettaLaunchOptions {
                initial_profile: launch.initial_profile,
                initial_project: launch.initial_project,
                launch_theme_override: launch.launch_theme_override,
                no_mux: launch.no_mux,
            ...
            WindowLaunchOptions {
                ...
                enable_performance_overlay: launch.profiling,
                performance_report: launch.performance_report,
                profile_pane_stress: launch.profile_pane_stress,
