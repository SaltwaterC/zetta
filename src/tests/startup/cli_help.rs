...
use zwt::{
    WorktreeInvocation, worktree_abort_help_for, worktree_config_help_for, worktree_done_help_for,
    worktree_help_for, worktree_new_help_for, worktree_status_help_for, worktree_sync_help_for,
};
...
fn help_text_uses_title_case_and_lists_built_in_features() {
    ...
    #[cfg(feature = "worktree")]
    {
        ...
        assert!(help.contains("Create, integrate, synchronize, configure, or abort Git worktrees"));
...
fn worktree_help_lists_every_operation_and_path_only() {
    for help in [
        ...
        worktree_sync_help_for(WorktreeInvocation::Zetta),
        worktree_config_help_for(WorktreeInvocation::Zetta),
    ] {
    ...
    assert!(worktree_help_for(WorktreeInvocation::Zetta).contains("zetta wt sync [COMMIT]"));
    assert!(worktree_help_for(WorktreeInvocation::Zetta).contains("zetta wt config"));
