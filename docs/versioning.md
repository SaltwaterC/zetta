...
| `CONTROL_VERSION` | `2` | `crates/zmux/src/protocol.rs` | The Zetta-to-Zetta process-control endpoint and request meanings, including disk-session resume, managed-worktree project opening, and explicit fresh-window launches | Endpoints with another version are skipped. |
